...
### 回答 5
真的不是很多......  
作为一名大学生，我喜欢制作东西。我对此并不擅长，但享受了在电脑上制作东西并看到它的工作。作为专业的我继续编程，但不是作为一个全吹的程序员。我积极参加测试自动化和性能测试。我很有动力，了解更多关于编码的信息，甚至为我的整个智能家庭编程（当时需要大量的编程，因为没有箱子的解决方案......）。  
随着时间的推移，我变得越来越逊于学习真正正确的代码。我仍然可以代码足够好，因为我想要/需要，然后我喜欢这样做。但我不是一个编码者，不想成为。我代码在我需要以及我需要代码时，我喜欢做的事情。但我真的不认为这是我的爱好。  
### 回答 6
我觉得我觉得我学习了新事物，我开发和感知我得到了新的优势 - 我可以看到我如何看待前端开发的差异，我更接近f  
...
这就是我的激励。  
### 回答 7
微分方程激励我的代码。微分方程可用于模拟物理世界，以极高的准确性。  
然而，分析地解决了微分方程并不总是可能的。我们，人类，已经开发了数值近似于对这些微分方程的解决方案的技术。微分方程的数值解决方案可能取决于您正在解决的内容以及您拥有的资源和专业知识的情况取决于余地。  
几乎所有情况下的这些数值技术都可以很容易地用您喜爱的编程语言编写。让我们乘坐一个非常着名的多人主科软件，以解决物理学各种各样的问题。  
虽然我们进行了研究，但我们经常需要编写自己的求解器，完全控制我们想要做的事情。多次，我们没有任何预先存在的代码，以便我们需要从头开始代码。  
编程技能增强您可以做的工作量。作为一个初学者，我建议有人去Python，因为它很容易，你不关心更有技术的东西等数据类型等。  
### 回答 8
当我击中40时，我也遇到了一个职业上限。我喜欢我的所作所为，它已经让我走得很远，但没有人真的关心良好的代码，只要它就是这样做。  
除非我承担更多领导，否则我不能在我目前的角色中成长;我对做的事情不感兴趣。所以我的同伴宁愿参加会议，而不是写作代码，现在是董事和vps在赔偿和影响方面让我陷入困境。  
我大多数日子都感觉良好。我的日历大多明确了会议，我可以在最终拍摄时间，并尽力而为。然而，偶尔偶尔，我得到了一个我知道很长一段时间的人，当我看到他们的头衔时，我感到舒适。  
我们只不过是在一个人在一个擅长_people_而不是计算机的人那些擅长那些擅长的人的机器而不是计算机的机器。这种实现是最悲伤的事情，即为我成为一个程序员。  
### 回答 9
这些照片中的家伙是我的父亲，他从未在他的生活中进入厨房，但在母亲的消亡后他学到了很多事情。今天，他洗了用具，可以做茶和早餐，他可以制作罗特斯并相信我的每一口他的轮子都遇到了我的灵魂，让我的灵魂难以让叮咬有价值  
有趣的事实是他从不假装是虔诚的，但我已经看到他的眼睛很多泪水。  
我见过一位父亲努力更换母亲。  
既不是一种励志视频，也不只是这些图片是我动机的源泉  
编辑：  
谢谢AISWARYA RAJU进行转换我  
这些照片中的家伙是我的父亲，他从未在他的生活中进入厨房，但在母亲的消亡后他学到了很多事情。今天，他洗了用具，可以做茶和早餐，他可以制作罗特斯并相信我的每一口他的轮子都遇到了我的灵魂，让我的灵魂难以让叮咬有价值  
有趣的事实是他从不假装是虔诚的，但我已经看到他的眼睛很多泪水。  
我见过一位父亲努力更换母亲。  
既不是一种励志视频，也不只是这些图片是我动机的源泉  
编辑：  
谢谢Aiswarya Raju将其转化为美丽的剪辑。  
### 回答 10
随着Rahul Sharma指出编码，每天都是一个伟大的策略。我也跟着它。如果您定期编码21天，则不会发生任何突发，它将成为您日常生活的一部分。每天我都完成了存储库的逻辑组件。我还尝试在一周中的每一天切换语言和技术，以确保我的一些个人项目不会遭受饥饿。  
除了你可以通过建立东西来帮助自己来激励自己。我经常编写脚本来自动化很多东西，并简化我的编程任务。一些通常的任务包括在每个星期三早上自动下载Flash TV节目，或者自动检查我的个人Web服务器日志以获取错误，并通过通知向我报告给我。这项小型任务可以在提高整体生产力和动机方面进行很长的路要走。  
另一个随机的黑客来激励自己是通过传奇编码人员阅读和聆听良好的演讲。当你倾听动机演讲时，突然爆发你得到的情绪可以令人难以理解。  
我还使用粘滞便笺和计算成本/效益比，每个编程任务都是如此。这有助于让我优先考虑重要的东西，并激励我最大限度地提高影响指数。太多的粘滞便笺也迫使我完成长期的待定任务，并在墙上取出一份记录。  
我的一位朋友使用非常酷的技巧。他买了啤酒。规则是他不能拥有它，除非他完成了日子任务。他有效地为自己创造了一个截止日期，让自己迫使自己在压力下工作。最后，他能够为他刚完成的任务奖励自己。  
### 回答 11
T.  
我可以理解你的观点，我猜这是几乎每个人的问题。如果没有真正的动机（大多数次数是必要的）这样做，它很难经历一个艰难的过程（因为它与学习如何编程）。  
通常我面临着新的编程语言或技术，我对自己的ID说，喜欢学习。这个故事总是相同的。我看到了一些东西，我决定要做的事情，我下载每一块相关的软件和教程在互联网上，像疯狂一样疯狂，然后我一点点停下来，永远不会再回到它。  
我真的学习的成功案例总是来自真正需要这样做的事情，因为我的工作取决于它。  
我接受并与它的方式接受并和平。我知道这很难有足够的力量将能够为学习而努力学习。它总是更舒服，不要做它，即使你是非常动力的，你的动机也会最终消失，只是因为我们有了我们的起伏。  
我对你的建议，如果我想真正学习一些东西，我会做什么，并确保我不会戒掉它是为了让一些重要的东西取决于它。在你的情况下，你说你把它作为一个项目经理工作。你为什么不从你自己管理的一个项目中分配一块东西？我不确切地知道管理项目的过程如何工作，但是让您说你的初步会议并为人们提供任务，以实际计划，你拍了一个简单的组成部分，你告诉其他人在这里照顾这篇文章，不要担心，我需要做一些编程工作，以便更多地参与整个项目。  
那时，你会取决于你的东西。你不会想回到你的字，你想要证明自己，别人可以做到这一点。没有逃避你需要完成那件事的事实。你可能会后悔，因为你经历过的过去，而且最终，你会学会了如何做一些真正的世界编程。  
