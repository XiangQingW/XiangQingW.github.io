...
title: 我已经学会了Python，HTML和CSS，但我没有学习JavaScript，DSA和任何框架。我可以申请我的技能吗？
...
## 我已经学会了Python，HTML和CSS，但我没有学习JavaScript，DSA和任何框架。我可以申请我的技能吗？  
### 回答 1
主要是没有。 Web开发人员需要了解JavaScript及其框架。假设网站作为汽车，HTML将是汽车的车身，CSS将是汽车的装饰品。但是，您需要发动机，电池和其他部件来运行汽车。在Web开发中，JavaScript充当这些部分。要制作一个动态网站，您需要JavaScript或其框架。因此，任何招聘人员都将在雇用您作为Web开发人员之前评估您的JavaScript技能。  
如果您希望使用Python知识进入开发人员工作，则数据结构和算法是必不可少的。 oops和dsa是将评估的两个主要内容，因此必须知道。  
### 回答 2
您可以作为专门从事Python专注的后端开发人员。  
...
＃世界和平  
### 回答 3
不，学习编程语言就像学习用手一样。重要的是要知道的重要事项，但最终你不会用手赤手造成一个房子，你用工具来做。  
如果您的目标是学习Web开发，在您能够竞争入门级工作之前，您仍然有很多才能学习。  
尝试拾取烧瓶，mysql和反应。然后构建一些非琐碎的全堆叠应用程序。  
祝你好运！  
### 回答 4
如果您正在寻求前端Web工作，您需要在某种程度上学习JavaScript。在购物之前，您不需要完全掌握语言;大部分工作正在使用相当简单的代码选择和串行开源包。  
...
### 回答 6
嗯，掌握HTML和CSS和CSS和CSS，通过在Airbnb（94,100美元）的大学里，通过展示招聘人员我的命令在包括HTML，CSS的各个方面的指挥和JavaScript，通过我发达的项目的手段，我相信我应该向这个问题提出答案，以便让你的学习不如我的麻烦。  
...
### 回答 8
每一项成就都开始尝试决定  
2个月足以学习网站开发。我在说这个，因为4个月回来我面临同样的问题。所以让我解释一下你需要一步一步的事情。  
### 回答 9
是的，完美好。JavaScript可以在许多相同的区域中使用，因为Python是。  
### 回答 10
...
TDA.  
### 回答 12
在翻盖方面，HTML和CSS可以与基于Python的Web应用程序一起使用，但它们也可以与其他编程语言和Ruby上的框架一起使用，如Rails或Node.j  
Python是一种通用编程语言。 HTML（超文本标记语言）只是一种在浏览器中显示信息（超文本）的方式，而CSS（级联样式表）是一种允许HTML用颜色，间距等设计的语言。  
Python是多想象的，可以用于Web开发（涉及HTML和CSS），但它也可以做很多其他东西（一般计算，科学建模等）。  
在翻盖方面，HTML和CSS可以与在Python上构建的Web应用程序一起使用，但它们也可以与其他编程语言和框架一起使用Ruby在Rails或Node.js上使用Ruby，或者它们可以将自己作为静态存在于网络上网页。  
结论：您不需要知道HTML或CSS来学习Python，您不需要知道Python使用HTML或CSS。他们都非常有用，但你不需要担心在另一个之前学习一个。  
CodeCademy.com是一个奇妙的网站，用于了解Python和HTML / CSS / JS。  
