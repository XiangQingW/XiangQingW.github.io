...
### 回答 3
您可以通过在网上阅读书籍和购买课程，如Udemy，Great Seach等，但我建议您参加像编码忍者，Codechef和Geeksforgeeks等哈纳松。  
### 回答 4
成为某些语言或开发环境的导师。  
...
### 回答 5
在程序员中有一个巨大的神话，需要一种像Facebook这样的Kickass平台或像口袋妖怪这样的花哨的游戏一样，可以致富它，  
...
$ 300 x 20 =每月$ 6000组成单一小公司.Imagine如果有些大公司拥有超过500的销售团队的数量。这是翻译成300 x 500 = $ 300 x 500 = $ 150,000 /月的收入。你可以开始建造SaaS应用吗？让我们变得逼真，你不能在一个月内像Salesforce那样建造SaaS应用程序，甚至在一年内。如果你今天开始，那么你可以获得在大约2  -  3年内建立SaaS产品所需的技能，只要你是专注。SaaS业务，技术和商务的两个主要方面.LET在细节中讨论。技术：  
我会假设你是一个新手编程器。你的第一件工作是熟悉像Java或Python这样的特定编程语言。我会亲自喜欢Python，因为它更容易，可以做各种各样的事情。在你想要的情况下可以做出各种各样的事情。从Python开始，我建议您阅读我的一个答案：Saurav Sharmas回答如何学习Python编程？什么是资源？一旦你遵循上面的答案并练习内部给出的内容，你应该熟悉Python和django.After这可以开始构建一些简单的应用程序，这些应用程序不需要超级幻想，只需构建一些简单的工具，可以解决您的日常问题。如果您能够构建简单，请尽可能多地解决您的日常问题。然后应用程序开始构建更复杂的。关于最佳编程实践，修补程序进入后端的东西，读取大的代码库并了解它们。我们的主要意图是在技术上装备来构建企业级应用程序.Business：  
能够建立一个萨斯产品无法够，您也需要了解销售他们的方法，以便人们实际支付他们。反对阅读博客/商业书籍的通用建议。我会建议您提出创意的方式推销您的产品。如果您愿意但不仅仅依赖于它们，请阅读一些营销书籍。您需要实际推销产品，以了解哪些策略以及哪一个毫无疑问。您不学会游泳通过阅读游泳书籍，您需要进入游泳池。  
### 回答 6
这是好莱坞传播的神话。真的。我不是在踩着阴谋理论，忍受我一会儿:-)  
每当你在电视上看到一个黑客：距离这是99次  
注意到这些描绘中的任何共同之处？是的，他们总是展示一个年轻人。事实上的真相是成为一个好的软件工程师，你需要经验。还有一些例外是天才，而且由于您可以在一个非常年轻的时代进入编程，您可以在研究生学院（至少编码）拥有10年的经验。但是，没有多年经验开发业务应用和良好领域知识的软件工程师，是金融，保险，建设，医疗，航空等。  
作为一个主要行业的编程已经发生了大约40年，并且在30年前在军事，美国宇航局和学术界处于较小的行业之后。所有人都在哪里去？根据好莱坞的说法，他们都需要爬进一个角落和枯萎......  
可是等等 ？那是什么？这是一架飞机吗？它是一只鸟吗？这是唐纳德Knuth：我们这个时间最有影响力的程序员和计算机科学家之一，仍然活跃，斯坦福国教授。我认为好莱坞忘了告诉他，他不符合他们的刻板印象。  
P.S .:  
如果您享受历史琐事的短片，请在Quora上订阅我的博客，称为历史比特。我每周都尝试添加一个故事或两个故事。  
### 回答 7
A2A。  
成为自由职业者的开发人员可能比你想象更容易。  
刚开始。多年来，你知道你的梦想，你知道你的梦想。 :)  
我在1981年开始，当时很少知道。这些天，有很多要知道的更多信息，而是几乎无穷无尽的学习材料，而且语言，框架和工具更强大。  
1）成为一个全堆叠开发人员。  
这意味着了解这些领域，以自己生产专业级产品：  
 - 需求收集 - 数据库设计和开发 - 服务 - 用户体验  
A2A。  
成为自由职业者的开发人员可能比你想象更容易。  
刚开始。多年来，你知道你的梦想，你知道你的梦想。 :)  
我在1981年开始，当时很少知道。这些天，有很多要知道的更多信息，而是几乎无穷无尽的学习材料，而且语言，框架和工具更强大。  
1）成为一个全堆叠开发人员。  
这意味着了解这些领域，以自己生产专业级产品：  
 - 需求收集 - 数据库设计和开发 - 服务 - 用户体验，图形设计 - 用户界面开发 - 部署 - 性能监控和增强  
你不必知道所有这些东西要开始自由职业。当然，你可以专门化。  
约翰·桑蒙兹有很多良好的材料，为什么你必须专注。我对约翰有很多尊重和欣赏。我相信这两种方法都有利弊（专门从事VS.概括），但值得听到约翰在这一主题上说的话。  
你不必刚刚开始才能开始。您可以专注于一个区域，直到您足够好以在该区域上工作，然后扩展。  
我建议将全堆栈建议的原因是如果您的自由职业者，这是为业务和软件公司工作的机会。  
如果您是专家，您可以为软件公司提供非凡的职业生涯。  
如果您的全堆栈，您也可以为企业工作。  
例如，您可以为大学，风险投资公司或小型零售商生产自定义申请。  
有人说全筹码是一个神话，但我不认为这争论很多。是的，我对SQL的少了解而不是SQL专家，但术语全堆栈仍然有用。我总是可以向一个SQL专家寻求帮助，并在必要时雇用他们。  
2）了解必要的商业技能。  
如何找到项目。  
如何获得报酬。  
如何处理困难的情况。  
3）诚信  
尽可能为您的客户做最好的事情，即使这意味着将它们推荐给别人而不是为他们工作。  
说实话。如果您遇到重大问题，请让客户知道。如果他们知道你面对的挑战，他们会有更多的患者。  
可靠。不要成为令人敬畏的工作几天的邪恶天才，然后消失了一周没有通知。  
希望这可以帮助！  
亚当  
### 回答 8
以下是一些事情：  
